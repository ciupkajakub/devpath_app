...
ActiveRecord::Schema.define(version: 2022_01_07_114918) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.uuid "category_uid", default: -> { "gen_random_uuid()" }, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.uuid "product_uid", default: -> { "gen_random_uuid()" }, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "purchases", force: :cascade do |t|
    t.datetime "purchase_date", precision: 6
    t.string "aasm_state"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
